...
public class MouseNodeGroup {
    ...
    private ArrayList<MouseNode> mouseNodes = new ArrayList<MouseNode>();
    ...
    public Rectangle getBoundingRectangle() {
        ...
        for (MouseNode mouseNode : mouseNodes) {
            ...
            if (mouseNode.getMouseAction().getType() != MouseAction.ACTION_MOVE)
                continue;
    ...
    public void resizeBoundingRectangle(float percentX, float percentY) {
        Rectangle boundingBox = getBoundingRectangle();
